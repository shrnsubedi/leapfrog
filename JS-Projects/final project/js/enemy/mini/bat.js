class BatEnemy {
	constructor() {
		...
		this.width = 15;
		this.height = 15;
		this.posGen = Math.floor(Math.random() * Math.floor(3)); //to find out the staring point of bat
		this.posGenValues = [318, 640, 960]; //three ends of the arena
		this.xDest = this.posGenValues[this.posGen]; //assign position according to posGen
		this.yDest = 122;
		this.widthDest = 30;
		this.heightDest = 30;
		this.moveDist = 10;
